            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse ">
                ...
                <li>
                    <div class="flex items-center space-x-1.5">
                        ...
                        <a href="{{ route('families.show', $subcategory->category->family->id) }}"
                            class="inline-flex items-center text-sm font-medium text-body hover:text-purple-700">
                ...
                <li>
                    <div class="flex items-center space-x-1.5">
                        ...
                        <a href="{{ route('categories.show', $subcategory->category->id) }}"
                            class="inline-flex items-center text-sm font-medium text-body hover:text-purple-700">
                ...
                <li aria-current="page">
                    <div class="flex items-center space-x-1.5">
                        ...
                        <span
                            class="inline-flex items-center text-sm font-medium text-body-subtle">{{ $subcategory->name }}</span>
                    </div>
                </li>
            </ol>
        </nav>
