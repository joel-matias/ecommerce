            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse ">
                ...
                {{-- <li>
                    <div class="flex items-center space-x-1.5">
                        ...
                        <a href="#"
                            class="inline-flex items-center text-sm font-medium text-body hover:text-purple-700">Projects</a>
                    </div>
                </li> --}}
                <li aria-current="page">
                    <div class="flex items-center space-x-1.5">
                        ...
                        <span
                            class="inline-flex items-center text-sm font-medium text-body-subtle">{{ $family->name }}</span>
                    </div>
                </li>
            </ol>
        </nav>
