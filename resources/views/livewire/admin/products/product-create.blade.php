<div>
    <form wire:submit="store">
        <figure class="mb-4 relative">
            ...
            <img src="{{ $image ? $image->temporaryUrl() : asset('img/images.png') }}" alt=""
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <x-text-area rows="4" wire:model="product.description" class="w-full"
            ...
            <div class="mb-4">
                ...
                <x-select wire:model.live="product.sub_category_id" class="w-full">
                    <option value="" disabled>
